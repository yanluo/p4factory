...
action again_count(){
	...
	add(counter_table_metadata.count2, counter_table_metadata.count2, 0x01);
        ...
        register_write(r7,counter_table_metadata.h_min, 0x06);
...
action do_cpu_encap() {
    ...
    shift_right(cpu_header.hash5, cpu_header.hash5, 1); 
    ...
    shift_right(cpu_header.count5, cpu_header.count5, 1);
...
action do_set_myvalue() {
    ...
    register_read(mymetadata.temp4, r6, counter_table_metadata.h_v4);
    register_read(mymetadata.temp5, r6, counter_table_metadata.h_v5);
...
control egress {
     apply(set_myvalue);
   if((counter_table_metadata.h_v1==mymetadata.temp1) or (counter_table_metadata.h_v2 == mymetadata.temp2) or (counter_table_metadata.h_v3 == mymetadata.temp3) or (counter_table_metadata.h_v4 == mymetadata.temp4) or (counter_table_metadata.h_v5 == mymetadata.temp5)){ 
    		apply(old_table_entry_array);       		
                if (((counter_table_metadata.count1 < counter_table_metadata.count2) and  (counter_table_metadata.count1 < counter_table_metadata.count3) and (counter_table_metadata.count1 < counter_table_metadata.count4) and (counter_table_metadata.count1 < counter_table_metadata.count5)) or ((counter_table_metadata.count1 < counter_table_metadata.count2) and (counter_table_metadata.count1 == counter_table_metadata.count3) and (counter_table_metadata.count1 == counter_table_metadata.count4) and (counter_table_metadata.count1 == counter_table_metadata.count5)) or ((counter_table_metadata.count1 < counter_table_metadata.count2) and (counter_table_metadata.count1 < counter_table_metadata.count3) and (counter_table_metadata.count1 == counter_table_metadata.count4) and (counter_table_metadata.count1 == counter_table_metadata.count5)) or ((counter_table_metadata.count1 < counter_table_metadata.count2) and (counter_table_metadata.count1 < counter_table_metadata.count3) and (counter_table_metadata.count1 < counter_table_metadata.count4) and (counter_table_metadata.count1 == counter_table_metadata.count5))){
          apply(minimum_val1);}
               if (((counter_table_metadata.count2 < counter_table_metadata.count1) and  (counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 < counter_table_metadata.count4) and (counter_table_metadata.count2 < counter_table_metadata.count5)) or ((counter_table_metadata.count2 == counter_table_metadata.count1) and (counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 == counter_table_metadata.count4) and (counter_table_metadata.count2 == counter_table_metadata.count5)) or ((counter_table_metadata.count2 == counter_table_metadata.count1) and (counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 < counter_table_metadata.count4) and (counter_table_metadata.count2 == counter_table_metadata.count5)) or ((counter_table_metadata.count2 == counter_table_metadata.count1) and (counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 < counter_table_metadata.count4) and (counter_table_metadata.count2 < counter_table_metadata.count5))){
         apply(minimum_val2);}
                if (((counter_table_metadata.count3 < counter_table_metadata.count1) and  (counter_table_metadata.count3 < counter_table_metadata.count2) and (counter_table_metadata.count3 < counter_table_metadata.count4) and (counter_table_metadata.count5 < counter_table_metadata.count5)) or ((counter_table_metadata.count3 == counter_table_metadata.count1) and (counter_table_metadata.count3 == counter_table_metadata.count2) and (counter_table_metadata.count3 < counter_table_metadata.count4) and (counter_table_metadata.count3 == counter_table_metadata.count5)) or ((counter_table_metadata.count3 == counter_table_metadata.count1) and (counter_table_metadata.count3 == counter_table_metadata.count2) and (counter_table_metadata.count3 < counter_table_metadata.count4) and (counter_table_metadata.count3 < counter_table_metadata.count5)) or ((counter_table_metadata.count3 < counter_table_metadata.count1) and (counter_table_metadata.count3 == counter_table_metadata.count2) and (counter_table_metadata.count3 < counter_table_metadata.count4) and (counter_table_metadata.count3 < counter_table_metadata.count5))){
          apply(minimum_val3);}
               if (((counter_table_metadata.count4 < counter_table_metadata.count1) and  (counter_table_metadata.count4 < counter_table_metadata.count2) and (counter_table_metadata.count4 < counter_table_metadata.count3) and (counter_table_metadata.count4 < counter_table_metadata.count5)) or ((counter_table_metadata.count4 == counter_table_metadata.count1) and (counter_table_metadata.count4 == counter_table_metadata.count2) and (counter_table_metadata.count4 == counter_table_metadata.count3) and (counter_table_metadata.count4 < counter_table_metadata.count5)) or ((counter_table_metadata.count4 < counter_table_metadata.count1) and (counter_table_metadata.count4 == counter_table_metadata.count2) and (counter_table_metadata.count4 == counter_table_metadata.count3) and (counter_table_metadata.count4 < counter_table_metadata.count5))  or ((counter_table_metadata.count4 < counter_table_metadata.count1) and (counter_table_metadata.count4 < counter_table_metadata.count2) and (counter_table_metadata.count4 == counter_table_metadata.count3) and (counter_table_metadata.count4 < counter_table_metadata.count5))) {
          apply(minimum_val4);}
               if (((counter_table_metadata.count5 < counter_table_metadata.count1) and  (counter_table_metadata.count5 < counter_table_metadata.count2) and (counter_table_metadata.count5 < counter_table_metadata.count3) and (counter_table_metadata.count5 < counter_table_metadata.count4)) or ((counter_table_metadata.count5 < counter_table_metadata.count1) and (counter_table_metadata.count5 == counter_table_metadata.count2) and (counter_table_metadata.count5 == counter_table_metadata.count3) and (counter_table_metadata.count5 == counter_table_metadata.count4))  or ((counter_table_metadata.count5 < counter_table_metadata.count1) and (counter_table_metadata.count5 < counter_table_metadata.count2) and (counter_table_metadata.count5 == counter_table_metadata.count3) and (counter_table_metadata.count5 == counter_table_metadata.count4)) or ((counter_table_metadata.count5 < counter_table_metadata.count1) and (counter_table_metadata.count5 < counter_table_metadata.count2) and (counter_table_metadata.count5 < counter_table_metadata.count3) and (counter_table_metadata.count5 == counter_table_metadata.count4))){
          apply(minimum_val5);}
