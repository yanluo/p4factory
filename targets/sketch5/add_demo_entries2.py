...
#------------------send_frame table entries with parameters for 8 hosts-----------------------------# 
...
#-----------------------forward table entries with parameters for 8 hosts----------------------------# 
...
#----------------------ipv4_lpm entries with parameters for 8 hosts------------------------------------#
...
client.minimum_val5_table_add_with_min_val5(sess_hdl, dev_tgt)     # minimum_val5 table entry
client.minimum_val4_table_add_with_min_val4(sess_hdl, dev_tgt)     # minimum_val4 table entry
