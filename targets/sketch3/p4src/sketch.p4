...
action again_count(){
	...
	add(counter_table_metadata.count2, counter_table_metadata.count2, 0x01);
        ...
        register_write(r5,counter_table_metadata.h_min, 0x06);
        modify_field(counter_table_metadata.temp, 0xFF);
}
...
action do_set_myvalue() {
    modify_field_with_hash_based_offset(counter_table_metadata.h_v1,0,ipv4_hash1,544);
    modify_field_with_hash_based_offset(counter_table_metadata.h_v2,0,ipv4_hash2,544);
    modify_field_with_hash_based_offset(counter_table_metadata.h_v3,0,ipv4_hash3,544);
...
control egress {
   ...
   if((counter_table_metadata.h_v1 == mymetadata.temp1) or (counter_table_metadata.h_v2 == mymetadata.temp2) or (counter_table_metadata.h_v3 == mymetadata.temp3)){ 
    		apply(old_table_entry_array);
       		if (((counter_table_metadata.count1 < counter_table_metadata.count2) and (counter_table_metadata.count1 < counter_table_metadata.count3)) or ((counter_table_metadata.count1 < counter_table_metadata.count2) and (counter_table_metadata.count1 == counter_table_metadata.count3)) or ((counter_table_metadata.count1 < counter_table_metadata.count3) and (counter_table_metadata.count1 == counter_table_metadata.count2))) {
         apply(minimum_val1);}
                if (((counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 < counter_table_metadata.count1)) or ((counter_table_metadata.count2 < counter_table_metadata.count3) and (counter_table_metadata.count2 == counter_table_metadata.count1)) or ((counter_table_metadata.count2 < counter_table_metadata.count1) and (counter_table_metadata.count2 == counter_table_metadata.count3))){
         apply(minimum_val2);}
                if (((counter_table_metadata.count3 < counter_table_metadata.count2) and (counter_table_metadata.count3 < counter_table_metadata.count1)) or ((counter_table_metadata.count3 < counter_table_metadata.count1) and (counter_table_metadata.count2 == counter_table_metadata.count3)) or ((counter_table_metadata.count3 < counter_table_metadata.count2) and (counter_table_metadata.count3 == counter_table_metadata.count1))){
         apply(minimum_val3);} 
