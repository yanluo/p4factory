...
#------------------send_frame table entries with parameters for 10 hosts-----------------------------# 
...
match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 5)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:04"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 6)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:05"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 7)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:06"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 8)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:07"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 9)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:08"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

'''match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 10)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:09"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_send_frame_match_spec_t(standard_metadata_egress_port = 11)
action_spec = sketch_rewrite_mac_action_spec_t(action_smac=macAddr_to_string("00:aa:bb:00:00:0a"))
client.send_frame_table_add_with_rewrite_mac(sess_hdl, dev_tgt, match_spec,action_spec)'''

#----------------------------------------------------------------------------------------------------#

#-----------------------forward table entries with parameters for 10 hosts----------------------------# 
...
match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.4.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:04"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.5.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:05"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.6.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:06"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.7.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:07"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.8.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:08"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

'''match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.9.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:09"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)

match_spec = sketch_forward_match_spec_t(routing_metadata_nhop_ipv4=ipv4Addr_to_i32("10.0.10.10"))
action_spec = sketch_set_dmac_action_spec_t(action_dmac=macAddr_to_string("00:04:00:00:00:0a"))
client.forward_table_add_with_set_dmac(sess_hdl, dev_tgt, match_spec,action_spec)'''
#------------------------------------------------------------------------------------------------------#

#----------------------ipv4_lpm entries with parameters for 10 hosts------------------------------------#
...
match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.4.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.4.10"), action_port=5)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.5.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.5.10"), action_port=6)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.6.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.6.10"), action_port=7)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.7.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.7.10"), action_port=8)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.8.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.8.10"), action_port=9)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

'''match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.9.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.9.10"), action_port=10)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)

match_spec = sketch_ipv4_lpm_match_spec_t(ipv4_dstAddr=ipv4Addr_to_i32("10.0.10.10"),ipv4_dstAddr_prefix_length = 32)
action_spec = sketch_set_nhop_action_spec_t(action_nhop_ipv4=ipv4Addr_to_i32("10.0.10.10"), action_port=11)
client.ipv4_lpm_table_add_with_set_nhop(sess_hdl, dev_tgt, match_spec, action_spec)'''
#-------------------------------------------------------------------------------------------------------#
